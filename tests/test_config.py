...
from fortran_analyzer.config.project_config import (
    FortranProjectConfig, ConfigurationManager, create_default_config
)
...
class TestFortranProjectConfig:
    ...
    def test_config_yaml_roundtrip(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            assert loaded_config.max_translation_unit_lines == original_config.max_translation_unit_lines
    ...
    def test_create_from_template(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            config = manager.create_config_from_template(
                'generic',
                tmp_dir,
                overrides={'project_name': 'Override Test'}
            )
